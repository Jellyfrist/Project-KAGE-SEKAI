...
review_input_schema = {
    ...
    "properties": {
        ...
        # aspects are optional in your function, but often helpful to include
        "aspects": {
             "type": "array",
...
def analyze_review(product_id: str, product_name: str, review_text: str, aspects: list[str] = None):
    """
    Analyse review and return a JSON structure matching `review_schema`.
    """
...
review_tool = [{
    "name": "analyze_review",
    "description": "Analyse customer review into multiple aspects and output sentiment following MultiAspectReview schema.",

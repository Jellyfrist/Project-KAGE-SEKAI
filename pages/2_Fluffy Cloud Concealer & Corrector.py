...
# --- CONSTANTS ---
FIXED_PRODUCT_ID = "C001"
FIXED_PRODUCT_NAME = "คอลซีลเลอร์ยางลบ & คอเรคเตอร์ยางลบ (C001)" 
...
# --- HEADER & PRODUCT INFO ---
try:
    # สมมติว่าไฟล์นี้มีอยู่จริงใน assets/
    header_img = Image.open("assets/Concealer.png") 
...
st.title("FLUFFY CLOUD CONCEALER & CORRECTOR | คอลซีลเลอร์ยางลบ & คอเรคเตอร์")
st.markdown("""
คอลซีลเลอร์และคอเรคเตอร์เนื้อบางเบาสบายผิวแต่ให้การปกปิด  ระดับการปกปิด light to medium coverage
* เนื้อสัมผัสบางเบาสบายผิว
* ปกปิดปานกลาง
* บางเบาเกลี่ยง่ายไม่ตกร่อง
* กันน้ำกันเหงื่อไม่เป็นคราบ

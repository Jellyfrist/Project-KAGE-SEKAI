...
# --- CONSTANTS ---
FIXED_PRODUCT_ID = "L001"
FIXED_PRODUCT_NAME = "ลิปไก่ทอด (L001)" 
...
# --- HEADER & PRODUCT INFO ---
try:
    header_img = Image.open("assets/lip.png")
...
st.title("𝗦𝘆𝗿𝘂𝗽 𝗚𝗹𝗼𝘀𝘀𝘆 𝗟𝗶𝗽 | ลิปไก่ทอดแบบแท่ง")
st.markdown("""
กลอสไซรัปพัฒนามาจากลิปไก่ทอดในรูปแบบแท่งพกพาง่าย เนื้อกลอสกลบสีปากพร้อมบำรุงให้ความฉ่ำเหมือนเพิ่งกินไก่ทอด
...
- ถ้าเป็นคำถามทั่วไป เช่น สีอะไร ปริมาณเท่าไหร่ ขนาดเท่าไหร่ ราคาเท่าไหร่ ให้ตอบข้อมูลเท่านั้น
...
if prompt:
    ...
    with st.chat_message("assistant", avatar="💖"): 
        ...
        st.session_state[CURRENT_PAGE_KEY].append({ # **ใช้ CURRENT_PAGE_KEY ในการบันทึก**
            ...
            "content": resp["answer"],
            "context_used": True,
            # ลบ sources ออกจากหน้าจอ แต่ยังบันทึกใน session state (optional)
